...
export const getUserDetails = (id) => async (dispatch, getState) => {
    try {
        ...
        // Make request to server and get the response data
        const { data } = await axios.get(`http://localhost:2000/api/users/${id}`, config)
...
export const getUserInfoDetails = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('http://localhost:2000/api/users/userInfo')
...
export const getUserDesc = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('http://localhost:2000/api/users/latest-patient')
...
export const updateUserStaff = (id, user) => async (dispatch, getState) => {
    try {
        ...
        // Make request to server and get the response data
        const { data } = await axios.put(`http://localhost:2000/api/users/${id}/updateStatus`, user, config)
